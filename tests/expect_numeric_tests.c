...
TEST(expect_numeric, expect_not_equal) {
...
/* Comparison checks */
TEST(expect_numeric, expect_less_than) {
...
TEST(expect_numeric, expect_less_than_equal) {
...
TEST(expect_numeric, expect_greater_than) {
...
TEST(expect_numeric, expect_greater_than_equal) {
